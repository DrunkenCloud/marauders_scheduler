    ...
    .sort((a, b) => {
      ...
      switch (sortBy) {
        case 'groupName':
          ...
          break
        case 'memberCount':
          aValue = a._count.facultyMemberships
          bValue = b._count.facultyMemberships
          break
        case 'createdAt':
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-sm text-gray-600">
        Showing {filteredAndSortedGroups.length} of {groups.length} faculty groups
      </div>

      {/* Groups List */}
      {filteredAndSortedGroups.length === 0 ? (
        <div className="text-center py-8 text-gray-500">
          {searchTerm ? 'No faculty groups match your search.' : 'No faculty groups found.'}
        </div>
      ) : (
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                      {group._count.facultyMemberships} members
                    </span>
                  </div>
